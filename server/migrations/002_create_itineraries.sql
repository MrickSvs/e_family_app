...
CREATE TABLE IF NOT EXISTS itineraries (
    ...
    price DECIMAL(10,2),
    image_url TEXT,
    tags VARCHAR[] NOT NULL DEFAULT '{}', -- tableau de tags pour faciliter la recherche
    points JSONB NOT NULL DEFAULT '{}', -- stockage des points de l'itinéraire avec leurs coordonnées et étapes
